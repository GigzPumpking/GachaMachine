...
p5.prototype.Letter3D = function(letter, depth, size, resolution, bevelled = true, font = "Georgia", style = BOLD) {
    ...
    this.create = function() {
        // Create the 2D graphic with a larger canvas to avoid clipping
        var graphic = createGraphics(this.resX, this.resY * 1.5);
        ...
        graphic.fill(0); // Ensure the text color is black for proper detection
